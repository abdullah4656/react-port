import{j as e,N as t}from"./index-CzG4PNbd.js";import{N as s,F as o}from"./Footer-OJ7WNKQ-.js";const i=()=>e.jsxs(e.Fragment,{children:[e.jsx(s,{}),e.jsxs("section",{className:"bg-gray-100 p-6 lg:p-11",children:[e.jsxs("div",{className:"flex flex-col lg:flex-row  text-center lg:text-left",children:[e.jsx("div",{className:"w-full lg:w-1/2",children:e.jsxs("div",{className:"text-gray-800",children:[e.jsxs("h2",{className:"text-3xl sm:text-4xl font-bold",children:["Welcome to"," ",e.jsx("span",{className:"logo-main text-blue-600 pt-1 text-3xl sm:text-4xl lg:text-5xl font-serif italic",children:"CodeViper  –"})," ","Where Technology Meets Passion"]}),e.jsxs("p",{className:"pt-5 text-sm sm:text-base md:text-lg",children:["At"," ",e.jsx("span",{className:"italic text-blue-600 logo",children:"Code Viper"}),", we're more than just tech enthusiasts – we're problem solvers with a passion for bringing bold ideas to life. Our goal? To help your business stand out in the digital age. Whether you're starting from scratch or enhancing what you already have, we provide IT solutions tailored specifically to your needs, guiding you through every step of the process."]}),e.jsxs("p",{className:"pt-3 text-sm sm:text-base md:text-lg",children:["At"," ",e.jsx("span",{className:"italic text-blue-600 logo",children:"Code Viper"}),", it's not just about delivering tech – it's about building partnerships. We take the time to learn about your goals, collaborate closely, and support your journey to new levels of success. Ready to transform your business? Let's make it happen, together."]}),e.jsxs("div",{className:"flex flex-row   gap-5 pt-7 justify-center lg:justify-start",children:[e.jsx(t,{to:"/contact",className:"text-blue-600 button  sm:w-1/3 mq-buttons  h-12 flex items-center justify-center  font-sans font-bold rounded-md bg-white button-white",children:e.jsx("span",{children:"Contact us"})}),e.jsx("a",{className:"bg-blue-600 hover:bg-blue-800 w-1/2 sm:w-1/3  flex items-center justify-center h-12 text-lg font-bold rounded-md text-white",target:"_blank",href:"tel:+923186840896",children:"Call Now"})]})]})}),e.jsx("div",{className:"w-full lg:w-1/2 mt-6 lg:mt-0",children:e.jsx("img",{src:"images/aboutus.png",alt:"About CodeEssence",loading:"lazy",className:"w-full h-auto object-cover"})})]}),e.jsx("style",{jsx:!0,children:`
        .logo{
