    ...
    <nav className='flex justify-between m-2 items-center bg-black p-4'>
     ...
     <a className="logo mqlogo  font-bold text-4xl" href='/'>AY </a>
      <div className="flex gap-6 mr-10 items-center">
        ...
        <button  onClick={handleGetInTouchClick} className='getin focus:ring-2  font-semibold shadow-2xl flex mx-auto text-white  border-0 py-2 px-8   rounded text-lg   transition-transform duration-300 hover:scale-105 focus:ring-gray-500 focus:outline-none'>
        Get in Touch
      </button>
