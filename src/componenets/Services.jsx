...
const Services = () => {
  ...
  return (
    <section className="w-full h-full">
      <h3 className='flex mq-heading justify-center text-5xl font-medium p-8 '>Our Services</h3>
    ...
    <g id="SvgjsG1037">
        <svg xmlnsXlink="http://www.w3.org/2000/svg" enableBackground="new 0 0 47.5 47.5" viewBox="0 0 47.5 47.5"
             >
            <defs>
                <clipPath id="a">
                    <path d="M0 38h38V0H0v38Z"  className="color000 svgShape"></path>
                </clipPath>
            </defs>
            <g clipPath="url(#a)" transform="matrix(1.25 0 0 -1.25 0 47.5)">
                <path 
                      ...
                      transform="translate(26.357 4.802)" className="color3b88c3 svgShape"></path>
            </g>
        </svg>
    </g>
</svg>
        ...
        <svg  xmlnsXlink="http://www.w3.org/2000/svg" fill-rule="evenodd" clip-rule="evenodd"
            ...
            <defs>
                <linearGradient id="a" x1="256" x2="256" y1="63.4" y2="448.8" gradientUnits="userSpaceOnUse">
                    <stop offset="0" stop-color="#fff" className="stopColor5cc6d0 svgShape"></stop>
                    <stop offset=".49" stop-color="#fff" className="stopColora53692 svgShape"></stop>
                    <stop offset="1" stop-color="#fff" className="stopColorf06277 svgShape"></stop>
                </linearGradient>
            </defs>
            <path 
              ...
              <h3 className="font-semibold text-black text-2xl mb-4 ">Desktop App Development</h3>
              <p className='  text-gray-600 hover:text-white  mb-4'>
              Empower your business with robust <br />desktop applications built for <br /> performance. Our applications are  <br />tailored to your business needs and <br /> promote efficiency.         </p>
            </div>
          </div>
          <div className="w-full sm:w-1/2 lg:w-1/3 p-4">
            <div className="h-full p-6 bg-slate-100  card rounded-md shadow-xl">
  ...
  <rect x="45" y="45" width="13" height="40" />
  <rect x="60" y="55" width="13" height="30" />
